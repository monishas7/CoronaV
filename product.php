				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><br><br><br>
							<br><br><br><br><br><br>
							'.$row['product_title'].'</h2>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Ajay</h5>
															<p class="date">27 NOV 2020, 8:0 PM</p>
													...
													<li>
														...
														<p class="date">17 nov 2020, 10:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Arya</h5>
														<p class="date">20 NOV 2020, 9:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
