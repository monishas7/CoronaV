	...
	<div class="container-fluid">
		...
		echo'
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process1.php" method="POST" class="was-validated">
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					<input type="hidden" name="total_price" value=Rs"'.$total.'">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Sign Up for <strong>NEWSLETTER</strong></p>
							<form >
